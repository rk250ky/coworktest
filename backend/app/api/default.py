...
def get_resources():
    ...
    print(calendar_dao.check_if_exist("IByHQiFjwaCWNSe6F-q8PpUZ6mU","c8a721c9-72af-472e-ad7d-7a9e9e15f3f0"))
    return render_template("base.html")
...
def get_notifications():
    ...
    name, check = calendar_dao.check_if_exist(resourceid,id_webhook)
    if check == False:
    ...
    if count_of_events_in_db == 0 or google_id == None or all_events == {}:
        print("NO SUCH VALUES IN DB SECOND TRIGGER")
        print_notification(notifications)
        return render_template("base.html")
